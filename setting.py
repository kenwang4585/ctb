...
allowed_user = ['unknown', 'kwang2', 'anhao', 'cagong', 'hiung', 'julzhou', 'julwu', 'rachzhan', 'alecui', 'daidai',
                'raeliu', 'karzheng','seyang','boonpng', 'peifang','skun', 'dooi', 'tpunyasa', 'teolee', 'chiyap',
                'lorzhou', 'lingsche', 'josepcha']
...
required_3a4_col=['SO_SS', 'PO_NUMBER', 'ORGANIZATION_CODE', 'BUSINESS_UNIT',
       'PRODUCT_FAMILY', 'PRODUCT_ID', 'MFG_HOLD', 'SECONDARY_PRIORITY',
       'GLOBAL_RANK', 'BUP_RANK', 'FINAL_ACTION_SUMMARY', 'ORDER_HOLDS',
       'ORDERED_QUANTITY', 'PACKOUT_QUANTITY',
       'C_UNSTAGED_QTY',
...
output_col=['ORGANIZATION_CODE', 'BUSINESS_UNIT', 'PRODUCT_FAMILY', 'SO_SS', 'PO_NUMBER','distinct_po_filter', 'EXCEPTION_NAME','PRODUCT_ID',
           ...
           'CURRENT_FCD_NBD_DATE','ORIGINAL_FCD_NBD_DATE', 'LT_TARGET_FCD','CUSTOMER_REQUESTED_SHIP_DATE','REVENUE_NON_REVENUE','C_UNSTAGED_DOLLARS',
            'ORDERED_QUANTITY','C_UNSTAGED_QTY','unpacked_qty','PACKOUT_QUANTITY','supply_allocation','tan_qty_wo_supply',
            ...
            'ss_updated_status', 'CTB_STATUS(CTB_UI)','GLOBAL_RANK']
